...
accent only; the regions are always labeled in words.

## Video — the screen leads

![Video layout, dark theme](shots/layout-video-dark.png)
...
## Materials — the shelf leads

![Materials layout, dark theme](shots/layout-materials-dark.png)
...
## People — the gathering leads

![People layout, dark theme](shots/layout-people-dark.png)
...
![Stage layout, dark theme](shots/layout-stage-dark.png)
...
_All four collapse to a single column — video, materials, people — under
760px. The video slot is an honest embed slot: when the room is live it
raises the gold "Join Live Session" door; otherwise the stage frame waits,
labeled. Both themes (dark + dawn) in `shots/`._
