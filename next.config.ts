...
const nextConfig: NextConfig = {
  ...
  transpilePackages: ["@pacsarcade/arcade-ui", "@pacsarcade/puck-config", "@pacsarcade/plugin-rails", "@pacsarcade/puck-changelog", "@pacsarcade/variant-engine", "@pacsarcade/presence"],
