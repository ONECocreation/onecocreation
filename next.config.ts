...
const nextConfig: NextConfig = {
  ...
  transpilePackages: ["@frens-earth/arcade-ui", "@frens-earth/puck-config", "@frens-earth/plugin-rails", "@frens-earth/puck-changelog", "@frens-earth/variant-engine", "@frens-earth/presence", "@onecocreation/operator-auth", "@onecocreation/page-store"],
