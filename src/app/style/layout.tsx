...
/**
 * The STYLE editor's OWN top-level layout (PUCK P2, Admiral-approved
 * 2026-08-10 — escape the console chrome). /a/studio (P1) rendered inside
 * the console shell (src/app/a/layout.tsx), which squeezed Puck's own
 * full-app editor into the console's locked content strip. Moving the
 * route out from under /a means this layout is the ONLY chrome around the
 * editor: no SiteHeader, no console sidebar/header — just full-bleed
 * viewport. The route still gates itself exactly like every /a room (each
 * page checks operatorFromCookieHeader itself; see [[...slug]]/page.tsx) —
 * this layout doesn't add auth, it only removes furniture.
