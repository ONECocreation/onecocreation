 ...
 *
 * The interactive half of /bday — the page itself is a server component so
 * it can carry metadata and the site shell.
 */
...
function convert(value: string, tip: number | null): Bday | null {
  ...
  const moon = moonPhase(height, utc); // the typed day's own instant — not the flat model
...
export default function BdayChecker() {
