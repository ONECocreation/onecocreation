 ...
 * overrides on html[data-oc-theme="light"] and the brand board's
 * .oc-pv-light swatch pane; .oc-pv-dark re-pins night inside a light
 * document. (The /style preview overlay's panes are real nested documents
 * since TASK-233 — they derive from the attribute chain itself and don't
 * ride these scopes.)
 ...
 * Scope classes must match src/app/style/preview.css (.oc-pv-light/-dark).
 */
